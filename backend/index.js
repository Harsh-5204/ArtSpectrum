...
app.use(cors({
    origin: ["http://localhost:3001", "http://localhost:3002", "http://localhost:3003", "http://localhost:3004", "http://192.168.0.20:3001"],
    credentials: true,
...
app.post("/artist/addEvent",eventPicUpload.single('eventpicture'), AddEvents);
app.post("/artist/editEvent",eventPicUpload.single('eventpicture'), EditEvent);
