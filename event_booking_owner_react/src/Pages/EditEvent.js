...
function EditEvent() {
    ...
    const [formData, setFormData] = useState({
        ...
        eventpicture: null, // Initialize with null
    });
    ...
    const handleFileChange = (e) => {
        setFormData((prevData) => ({
            ...prevData,
            eventpicture: e.target.files[0], // Update eventpicture with selected file
        }));
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.post("http://localhost:8000/artist/editEvent", formDataToSend, {
                headers: {
                                ...
                                <div className="grid-margin stretch-card">
                                    <div className="card">
                                        <div className="card-body">
                                            ...
                                            <form onSubmit={handleSubmit} className="col-lg-12 form-group">
    {/* Form fields */}
