...
function Counts() {
    ...
    const fetchCounts = async () => {
        try {
            const response = await fetch("http://localhost:8000/admin/getCounts");
            ...
            <div className="row row-cols-1 row-cols-sm-2 row-cols-xl-3 g-3">
                <div className="col">
                    <div className="card h-100">
                        <div className="card-body  bg-primary d-flex flex-wrap justify-content-between">
                            <div>
                ...
                <div className="col">
                    <div className="card h-100">
                        <div className="card-body  bg-warning d-flex flex-wrap justify-content-between">
                            <div>
                                <h4 className="font-weight-semibold mb-1 text-black">
                                    Total Artists
                                </h4>
                ...
                <div className="col">
                    <div className="card h-100">
                        <div className="card-body bg-danger d-flex flex-wrap justify-content-between">
                            <div>
                                <h4 className="font-weight-semibold mb-1 text-black">
                                    Total Complain
                                </h4>
